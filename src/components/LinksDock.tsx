...
const Icons = {
  ...
  resume: (props: IconProps) => <ScrollTextIcon {...props} />,
...
const DATA = {
  socials: [
    {
      name: "GitHub",
      url: "https://www.github.com/vivianedias",
      Icon: Icons.github,
    },
    {
      name: "LinkedIn",
  ...
  contact: [
    ...
    {
      name: "Book a call",
      url: "https://calendly.com/vivianepdias/30min",
      Icon: Icons.calendar,
    },
  ],
};
  ...
  return (
    <TooltipProvider>
      <Dock direction="middle">
        {DATA.socials.map(generateDockIcon)}
        <Separator orientation="vertical" className="h-full" />
        {DATA.contact.map(generateDockIcon)}
      </Dock>
    </TooltipProvider>
  );
}
